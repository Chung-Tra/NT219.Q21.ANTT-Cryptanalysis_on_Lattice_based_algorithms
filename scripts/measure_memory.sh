...
#   - Same 12-algorithm matrix as run_micro.sh for table symmetry.
set -u
...
ALGOS=( "rsa 2048" "rsa 3072" "ecdsa p256" "ecdsa p384" "ecdh p256" "ecdh p384"
        "mlkem 512" "mlkem 768" "mlkem 1024" "mldsa 44" "mldsa 65" "mldsa 87" )

# Peak RSS is about footprint, not throughput -> short runs are enough.
export BENCH_ITERS=50 BENCH_KEYGEN_ITERS=10 BENCH_WARMUP=5
